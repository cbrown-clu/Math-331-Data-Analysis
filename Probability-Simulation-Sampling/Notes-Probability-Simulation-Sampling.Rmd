...
## Exercises
**Exercise ** Bad Driving!  A group of five roommates collectively have 10 car accidents in one year.  One of the roommates - Kevin, it's always Kevin! - is responsible for 6 of the 10 accidents.  His roommates tell him to start taking the bus, but Kevin claims it is just bad luck, and that he is no worse a driver than any of the others.
...
**Exercise ** More driving!  You pull up to a red stoplight behind some other cars.  How long will it take before you start moving again?  Assume that the number of cars ahead of you at the red light is Poisson distributed with mean 3, the wait time for each car including yours to begin moving after the car ahead has begun moving is uniformly distributed between 2 and 10 seconds, and the time for the red light to change to green is uniformly distributed between 0 and 60 seconds.  Give your expected wait time and the variance of your wait time.

**Exercise **  Let's imagine a building with 10 floors (including ground level) and one elevator, and not very many people going in or out.  In this building the elevator is fairly primitive and obeys the following rules:
...
**Exercise ** It's registration time for classes!  There are two sections of elementary physics, each with 40 seats available.
...
**Exercise ** Mark-Recapture Population Estimation.  We would like to estimate the population size of a certain species of animals in a certain region.  Let's call the unknown population size $N$.  We perform the following procedure to gather data and perform an estimate:
...
**Exercise ** Parrondo's Paradox.  Let's suppose that you begin with an amount of money $M$.  Here are two games you can play:
